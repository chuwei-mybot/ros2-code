...
def generate_launch_description():
    ...
    tribot_node = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory(package_name),'launch','tribot_follower2.launch.py'
                )]), launch_arguments={'use_sim_time': 'true', 'world':world_path,'robot_name':'tribot2'}.items()
    )
